...
export const Nosotros = () => {
	...
	return (
		<div className="fondo container-fluid float-lg-start">
            <div className="d-flex justify-content-center mt-4 mb-5 text-center">
            ...
            <div className="rectangulo2">
                ...
                <p className="text-start lh-sm ms-3 me-1">Abriendo el camino Desde nuestra fundación en 1965, hemos sido pioneros en nuevos estándares en el cuidado de mascotas, brindando soluciones integrales de bienestar a través de nuestros productos y servicios, y creando comunidades que profundizan el vínculo entre mascotas y padres.
                </p>
            </div>
            ...
            <div className="rectangulo3">
                ...
                Operamos más de 1,500 ubicaciones de Ropita en los EE. UU., México y Puerto Rico, incluida una red creciente de más de 100 hospitales veterinarios en la tienda, y ofrecemos un recurso completo en línea para la salud y el bienestar de las mascotas en petco.com y en la aplicación PetShop Café .
                </p>
            </div>
		</div>
	);
