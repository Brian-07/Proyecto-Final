...
export const PagEdicionArticulo = () => {
  return (
    <div className="container">
      <div className="d-flex justify-content-start mt-5">
        <h1 className="mt-5 display-2 titulo-login ms-5">Edítalo!</h1>
      </div>
      <div className="card bg-light mb-5 rounded-3 border-primary col-11 ms-5">
        <div className="row col-12 d-flex mb-5 mt-3">
          ...
          {/* Sub-Categoria */}
          <div className="text-bg-light col-2 mt-2 d-flex ms-2">
            <h3>Sub/Categoría:</h3>
          </div>
          {/* input Sub-Categoria */}
          ...
          <div className="col-6 d-flex align-items-end">
            <input
              ...
              placeholder="Cambia el Título del producto..."
          ...
          <div className="col-6 d-flex align-items-end form-floating">
            <textarea
              ...
              placeholder="Cambia la descripción del producto..."
            ></textarea>
          </div>
          <hr className="col-11 ms-5 mt-1 border border-primary border-2"></hr>
          {/* Detalles */}
          ...
          <div className="col-6 d-flex align-items-end form-floating">
            <textarea
              className="form-control"
              placeholder="Cambia los detalles del producto..."
              id="floatingTextarea2"
              style={{ height: "100px" }}
            ></textarea>
          </div>
          <hr className="col-11 ms-5 mt-1 border border-primary border-2"></hr>
          {/* Precio */}
          <div className="text-bg-light col-3 mt-3 d-flex ms-5">
            <h3>Cambia el Precio:</h3>
          </div>
          {/* Input 2 */}
