...
function CardPrevisualizaciónArticulo(){
    return(
    <div className='container row mt-5 pt-5'>
       {/* Imagen */}
        ...
        {/* Botones */}
        <div>
        <p className='row col-lg-12 d-flex justify-content-center pt-5'>
        <a href="#" className="w-25 btn btn-lg button-login text-light button-login1 me-5">Publicar producto</a>
...
export default CardPrevisualizaciónArticulo;